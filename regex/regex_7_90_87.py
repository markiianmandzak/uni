...
def parse_taxonomy(tax_df):
    print("1. Building Expanded High-Precision Ruleset...")
    taxonomy_rules = {}
    ...
    for _, row in tax_df.iterrows():
        ...
        if f_type == 'categorical':
            ...
            # Safe Packaging Units
            elif feat in ['Verpackungseinheit', 'Inhalt']:
            ...
            # Safe Anchored Dimensions
                ...
                # MUST have the anchor immediately before the number
...
def main():
    ...
    print("4. Running Expanded Extraction...")
    predicted_values = []
